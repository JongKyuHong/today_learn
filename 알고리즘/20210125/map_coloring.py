...
class MapColoringConstraint(Constraint[str,str]):
    ...
    def satisfied(self,assignmnet: Dict[str,str]) -> bool:
        if self.place1 not in assignmnet or self.place2 not in assignmnet:
            return True
        return assignmnet[self.place1] != assignmnet[self.place2]
